...
Script created by IPython team.
See https://github.com/ipython/ipython-website/tree/master/_scripts.

Warning, this script has been adapted to be used to openalea documentation
"""
...
if len(sys.argv) == 2 and sys.argv[1] == 'publish':
  ...
  html_dir = '_build/html'
  pages_repo = 'git@github.com:openalea/openalea-website.git'
